"""Identifies the object in image/video feed and sends commands to the gunner_controller"""
...
IP_ADDRESS = "LOCALHOST"  # listen on all available network interfaces
...
# ToDO: change this to a function that sends a command to the gunner_controller
